...
export async function GET(context) {
  const site = context.site?.toString().replace(/\/$/, '') || 'https://haomachat.com';
  ...
  const staticPages = [
    {
      url: `${site}/`,
      title: '号码通查首页',
      content: `号码通查(haomachat)提供号码标记查询与清除服务,手机号与座机号均支持。由脏兮兮科技运营,标记清除服务由授权合作方提供,官方数据来源为中国信通院码号服务推进组(opene164.org.cn)与Truecaller。查询免费,不存储号码数据。
...
材料清单: 个人需身份证+错误标记截图+号码归属证明; 企业需营业执照+经办人身份证+号码使用证明+错误标记截图。`,
    ...
    },
    {
      url: `${site}/about`,
      title: '关于号码通查',
      content: `号码通查(haomachat)由脏兮兮科技运营,提供号码标记查询与清除服务入口导航及知识科普。数据来源: 中国信通院码号服务推进组(opene164.org.cn)、Truecaller(truecaller.com)、聚合数据(juhe.cn)。运营原则: 透明、免费、安全、可追溯。不存储用户输入的号码数据。标记清除服务由授权合作方提供(xbh5.open10086.com)。`,
    },
    {
      url: `${site}/faq`,
      title: '常见问题',
    ...
    },
    {
      ...
      title: '号码标记清除渠道对比',
      content: `三渠道对比: 信通院(opene164.org.cn,免费,跨平台聚合,联通/400号一站式清除)、Truecaller(truecaller.com,免费,海外标记)、授权合作方服务(xbh5.open10086.com,支持手机号与座机号)。Article schema覆盖。`,
    },
    {
...
> 号码通查提供号码标记查询与清除服务,手机号码与座机(固话)号码均支持。标记清除服务由授权合作方提供,同时聚合中国信通院码号服务推进组(opene164.org.cn)与Truecaller官方入口。由脏兮兮科技运营,查询免费,不存储号码数据。
