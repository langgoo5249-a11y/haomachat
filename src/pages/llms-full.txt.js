...
材料清单: 个人需身份证+错误标记截图+号码归属证明; 企业需营业执照+经办人身份证+号码使用证明+错误标记截图。`,
    ...
    {
      url: `${site}/tools/registration-card`,
      title: '注册卡购买服务',
      content: `注册卡销售:0月租虚拟运营商SIM卡,只能接收106短信验证码,专门用于APP注册和账号验证。不能打电话、不能上网,必须实名激活。适用场景:APP账号注册、账号解封验证、工作室矩阵管理、保护主号隐私、多账号运营。添加微信SXLH-888咨询购买。`,
    },
    {
